...
final class DormWattTests: XCTestCase {
    ...
    func testSharedElectricityStoreSavesLatestRecord() throws {
        let defaults = makeDefaults()
        let store = SharedElectricityStore(defaults: defaults, fallbackDefaults: nil, fileURL: nil, usesLegacySharedDefaults: false)
    ...
    func testElectricityHistoryStoreSavesLoadsAndSortsRecords() throws {
        let defaults = makeDefaults()
        let store = ElectricityHistoryStore(defaults: defaults, fallbackDefaults: nil, fileURL: nil, usesLegacySharedDefaults: false)
        let now = Date()
    ...
    func testSettingsViewModelClearsCachedStoresWithoutClearingSettings() throws {
        let defaults = makeDefaults()
        let settingsStore = AppSettingsStore(defaults: defaults)
        let historyStore = ElectricityHistoryStore(defaults: defaults, fallbackDefaults: nil, fileURL: nil, usesLegacySharedDefaults: false)
        let sharedStore = SharedElectricityStore(defaults: defaults, fallbackDefaults: nil, fileURL: nil, usesLegacySharedDefaults: false)
